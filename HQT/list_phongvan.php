...
<?php
	$data_tsn = db_query_load_data("select tunghiepsinh.*, hoso.id_hoso from tunghiepsinh, hoso where tunghiepsinh.id_tns = hoso.id_tns AND hoso.hs_hoanthanhcoc=1 AND hoso.hs_1tuanhoc=1 AND hoso.hs_solanrot<=7 AND hoso.hs_ketquaphongvan<>1;");
?>
	<html>
		<head>
						...
						<div class="col-xs-9">
							<div class="panel panel-success">
								<div class="panel-heading">
									<h3 class="panel-title">Danh sách chờ phỏng vấn</h3>
								</div>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td class="text-center"><a href="capnhatphongvan_form9.php?idhs=<?php print $tns[9]; ?>">Xử lý</a></td>
												</tr>
											<?php endforeach; ?>
										</tbody>
									</table>
