...
<?php 
	//Load ra danh sach nhung tu nghiep sinh KO nam trong (danh sach nhung nguoi da cam ket) hoac (hoan thanh camket va kham suc khoe)
	$data_tsn = db_query_load_data("select * from tunghiepsinh where id_tns not in (select id_tns from tns_camket_khamsk where dacamket=1 OR status<>0);"); 
?>
	<html>
		<head>
						...
						<div class="col-xs-9">
							<div class="panel panel-success">
								<div class="panel-heading">
									<h3 class="panel-title">Danh sách tiến hành cam kết</h3>
								</div>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td class="text-center"><a href="camket_form3.php?id=<?php print $tns[0]; ?>">Xử lý</a></td>
												</tr>
											<?php endforeach; ?>
										</tbody>
									</table>
